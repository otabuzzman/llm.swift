...
Output of llm.swift's `train_gpt2` without Metal:
```
[GPT-2]
max_seq_len: 1024
vocab_size: 50257
...
Output of llm.swift's `test_gpt2` without Metal:
```
[GPT-2]
max_seq_len: 1024
vocab_size: 50257
...
Output of llm.c's `train_gpt2` with OpenMP:
```
[GPT-2]
max_seq_len: 1024
vocab_size: 50257
...
Output of llm.c's `test_gpt2` with OpenMP:
```
[GPT-2]
max_seq_len: 1024
vocab_size: 50257
